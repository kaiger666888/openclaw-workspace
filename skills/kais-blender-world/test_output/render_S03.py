...
look_at(cam,ctr)
scene.render.filepath=r'D:\BlenderAgent\outputs\dungeon\S03\\scene_closeup.png'
bpy.ops.render.render(write_still=True)
sys.stderr.write(f'[OK] closeup\\n')

cam.location=ctr+mathutils.Vector((-0.8,-1.0,1.0))
look_at(cam,ctr)
scene.render.filepath=r'D:\BlenderAgent\outputs\dungeon\S03\\scene_extreme_closeup.png'
bpy.ops.render.render(write_still=True)
