...
look_at(cam,ctr)
scene.render.filepath=r'D:\BlenderAgent\outputs\dungeon\S01\\scene_extreme_wide.png'
bpy.ops.render.render(write_still=True)
sys.stderr.write(f'[OK] extreme_wide\\n')

cam.location=ctr+mathutils.Vector((-3.5,-3.5,2.5))
look_at(cam,ctr)
scene.render.filepath=r'D:\BlenderAgent\outputs\dungeon\S01\\scene_wide.png'
bpy.ops.render.render(write_still=True)
sys.stderr.write(f'[OK] wide\\n')

cam.location=ctr+mathutils.Vector((-2.0,-2.5,1.8))
look_at(cam,ctr)
scene.render.filepath=r'D:\BlenderAgent\outputs\dungeon\S01\\scene_medium.png'
bpy.ops.render.render(write_still=True)
